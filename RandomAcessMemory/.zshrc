...
plugins=(git alias-tips per-directory-history)


# User configuration


  export PATH="/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/home/juliano/anaconda3/bin"
...
alias opt="nautilus /opt/lampp/htdocs"
